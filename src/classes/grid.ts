...
class grid {
     ...
     * @returns {gridCell[]} - An array of all cells.
     */
    public static getAll (grid: grid): gridCell[] {
        return grid.getAll();
    }
     ...
     * @param {number} x - The x coordinate to check.
     */
    public static getAllX (grid: grid, x: number): gridCell[] {
        return grid.getAllX(x);
    }
     ...
     * @param {number} y - The y coordinate to check.
     */
    public static getAllY (grid: grid, y: number): gridCell[] {
        return grid.getAllY(y);
    }
     ...
     * @param {number} y - The y coordinate to check.
     */
    public static getCell (grid: grid, x: number, y: number): gridCell {
    ...
    */
     ...
     * @param {gridCell} value The value to set for the cell.
     */
    public static setCell (grid: grid, x: number, y: number, value: gridCell): void {
        return grid.setCell(x, y, value);
    }
     ...
     * @param {number} y - The y coordinate to check.
     */
    public static getAdjacent (grid: grid, x: number, y: number): gridCell[] {
        return grid.getAdjacent(x, y);
    }
     ...
     * @param {number} y - The y coordinate to check.
     */
    public static getDiagonal (grid: grid, x: number, y: number): gridCell[] {
        return grid.getDiagonal(x, y);
    }
     ...
     * @param {number} y - The y coordinate to check.
     */
    public static getEncircling (grid: grid, x: number, y: number): gridCell[] {
        return grid.getEncircling(x, y);
    }
