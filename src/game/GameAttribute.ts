 ...
 */
class GameAttribute<TEnableBoost extends boolean = true> extends AttributeStatic<TEnableBoost> {
    /**
     ...
     */
    constructor(
        attributeStaticParams: ConstructorParameters<typeof AttributeStatic<TEnableBoost>>,
        gamePointer?: Game,
    ) {
