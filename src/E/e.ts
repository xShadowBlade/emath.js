...
class Decimal {
   ...
   */
    ...
    */
    public static format (e: DecimalSource, acc: number = 2, max: number = 9): string { return formats.format(new Decimal(e), acc, max); }
    ...
    */
     ...
     * @returns {string} A string representing the formatted E value.
     */
    public format (acc: number = 2, max: number = 9): string { return formats.format(this.clone(), acc, max); }
     ...
     */
    public formatGain (gain: DecimalSource): string { return formats.formatGain(this.clone(), gain); }
    public static formatGain (value: DecimalSource, gain: DecimalSource): string { return formats.formatGain(new Decimal(value), gain); }
