...
describe("Boost", () => {
    ...
    describe("constructor", () => {
        ...
        it("should create a boost with specified base effect and boosts", () => {
            ...
            assert(testBoost.baseEffect.equals(Decimal.dTen));
    ...
    describe("getBoosts", () => {
        it("should return an array of boost objects with the given ID", () => {
            ...
            assert(boosts[0].value(Decimal.dZero).equals(new Decimal(3)));
    ...
    describe("getBoost", () => {
        it("should return the boost object with the given ID", () => {
            ...
            assert(boost?.value(Decimal.dZero).equals(new Decimal(3)));
