...
- Finally, the game is initialized and loaded using the `init` and `loadData` methods of the `coinGame` object. This should be done after all currencies and upgrades are added.
