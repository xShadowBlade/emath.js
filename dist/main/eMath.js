...
var test = new Decimal(Math.random()).mul("1e" + Math.floor(Math.random() * 30));
console.log(test);
var testFormats = {
  standard: (x) => format(x, 2, 9, "st"),
  sc: (x) => format(x, 2, 9, "sc"),
  default: (x) => format(x, 2, 9),
  // gain: formatGain,
  omega: (x) => format(x, 2, 9, "omega"),
  omega_short: (x) => format(x, 2, 9, "omega_short"),
  elemental: (x) => format(x, 2, 9, "elemental"),
  old_sc: (x) => format(x, 2, 9, "old_sc"),
  eng: (x) => format(x, 2, 9, "eng"),
  mixed_sc: (x) => format(x, 2, 9, "mixed_sc"),
  layer: (x) => format(x, 2, 9, "layer"),
  inf: (x) => format(x, 2, 9, "inf"),
  metric,
  ev
};
...
var Decimal = class {
  ...
  */
  static format(e, acc = 2, max = 9) {
    return formats.format(new Decimal(e), acc, max);
  }
  /**
  ...
  */
   ...
   */
  format(acc = 2, max = 9) {
    return formats.format(this.clone(), acc, max);
  }
  /**
   ...
   */
  formatGain(gain) {
    return formats.formatGain(this.clone(), gain);
  }
  static formatGain(value, gain) {
    return formats.formatGain(new Decimal(value), gain);
  }
  /**
