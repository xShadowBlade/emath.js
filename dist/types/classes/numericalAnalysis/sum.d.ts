 ...
 */
declare function calculateSumLoop(f: (n: Decimal) => Decimal, b: DecimalSource, a?: DecimalSource, epsilon?: number): Decimal;
/**
 ...
 * console.log(sum); // ~385
 */
declare function calculateSum(f: (n: Decimal) => Decimal, b: DecimalSource, a?: DecimalSource, epsilon?: number, iterations?: number): Decimal;
