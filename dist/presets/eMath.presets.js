(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('class-transformer')) :
    typeof define === 'function' && define.amd ? define(['exports', 'class-transformer'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.eMathPresets = {}, global.classTransformer));
})(this, (function (exports, classTransformer) { 'use strict';
    ...
    function gameFormat(value, settings) {
        let { formatType, acc, max, time, multi, formatTimeType } = settings = Object.assign({
            formatType: "mixed_sc",
            acc: 2,
            max: 9
        }, settings);
        if (time) switch(formatTimeType){
            case "short":
                return Decimal.formats.formatTime(value, acc, formatType);
            case "long":
                return Decimal.formats.formatTimeLong(value, !0, 0, max, formatType);
        }
        return multi ? Decimal.formats.formatMult(value, acc) : Decimal.format(value, acc, max, formatType);
    }
    function gameFormatGain(value, gain, settings) {
        let { formatType, acc, max } = settings;
    ...
    class GameFormatClass {
        ...
        constructor(settings){
            this.format = (x)=>gameFormat(x, this.settings), this.gain = (x, gain)=>gameFormatGain(x, gain, this.settings), this.time = (x)=>gameFormat(x, {
                    ...this.settings,
                    time: !0
                }), this.multi = (x)=>gameFormat(x, {
                    ...this.settings,
                    multi: !0
                }), this.settingsFn = "function" == typeof settings ? settings : ()=>settings;
        }
    }
    let formatOptions = [
        {
    ...
    ].sort((a, b)=>a.name.localeCompare(b.name)), formatTimeOptions = [
        {
            name: "Short (default)",
            value: "short"
        },
    ...
    exports.GameFormatClass = GameFormatClass;
    exports.formatOptions = formatOptions;
    exports.formatTimeOptions = formatTimeOptions;
    exports.gameFormat = gameFormat;
    exports.gameFormatGain = gameFormatGain;
